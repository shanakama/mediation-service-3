...
final http:Client backendEP = check new (Endpoint, config = {secureSocket: {enable: check boolean:fromString("true"), cert: "/home/ballerina/ca.pem", verifyHostName: AdvancedSettings.hasKey("verifyHostname") ? AdvancedSettings.get("verifyHostname") : true}});
final http:Client sandboxEP = check new (SandboxEndpoint, config = {secureSocket: {enable: check boolean:fromString("true"), cert: "/home/ballerina/ca.pem", verifyHostName: AdvancedSettings.hasKey("verifyHostname") ? AdvancedSettings.get("verifyHostname") : true}});
